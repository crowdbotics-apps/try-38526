"""
Django settings for try_38526 project.
...
WSGI_APPLICATION = 'try_38526.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "try_38526 API",
    "DESCRIPTION": "API documentation for try_38526 App",
    "VERSION": "v1",
}
